...
export default function SubtleBackground() {
  return (
    <div className="absolute inset-0 -z-10 overflow-hidden">
      {/* Gradient overlay */}
      <div className="absolute w-full h-full bg-gradient-to-r from-violet-900 via-gray-900 to-violet-800 opacity-10"></div>
      ...
      <div className="absolute w-64 h-64 bg-violet-400/10 rounded-full top-[20%] right-[10%] animate-pulse-slow"></div>
