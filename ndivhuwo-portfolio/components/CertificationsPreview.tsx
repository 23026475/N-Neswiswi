...
const certifications = [
  ...
  { label: "AN-900", img: "/media/certs/ai900.png" },
    ...
    <section className="relative w-full py-20 bg-gradient-to-r from-violet-50 to-purple-50 dark:from-gray-900/50 dark:to-gray-800/50">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl sm:text-4xl font-extrabold text-primary mb-8"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex gap-4 md:gap-6 overflow-x-auto py-4 px-2 scrollbar-hide"
        >
          {certifications.map((cert, i) => (
            <motion.div
              key={i}
              whileHover={{ scale: 1.05 }}
              className="flex-shrink-0 flex flex-col items-center w-24 md:w-28 p-3 rounded-lg bg-background shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-transform"
            >
